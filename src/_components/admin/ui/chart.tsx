  ...
  return (
    <ChartContext value={{ config }}>
      <div
        ...
        <RechartsPrimitive.ResponsiveContainer debounce={150} width="100%" height="100%" initialDimension={{width: 400, height: 200}}>{children}</RechartsPrimitive.ResponsiveContainer>
      </div>
    </ChartContext>
  );
}
            ...
            <div
              ...
              {formatter && itemValue !== undefined && itemName ? (
                formatter(
                  itemValue,
                  itemName,
                  item as Payload<number | string, string>,
                  index,
                  payload as ReadonlyArray<Payload<number | string, string>>
                )
              ) : (
                <>
                  {itemConfig?.icon ? (
                  ...
                  <div
                    ...
                    {itemValue != null && typeof itemValue === "number" && (
